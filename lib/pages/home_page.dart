...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    //Check if listner is playing or not.
  ...
  setupAlan() {
    AlanVoice.addButton(
        "bde351eb59d9bf1d540ebd7c35c4c5e72e956eca572e1d8b807a3e2338fdd0dc/stage",
  ...
  fetchRadios() async {
    final radioJason = await rootBundle.loadString("assets/radio.json");
      ...
      drawer: Drawer(
        child: Container(
          ...
          child: radios != null
              ? [
                  100.heightBox,
                  "All Channles".text.xl3.semiBold.white.make().px16(),
                  20.heightBox,
                  ListView(
                    padding: Vx.m0,
                    shrinkWrap: true,
